...
export async function updateCustomer(id, data) {
  ...
  if ('invoiceFromDay' in data)
    updateData.invoiceFromDay = data.invoiceFromDay ?? null;
  if ('invoiceToDay' in data)
    updateData.invoiceToDay = data.invoiceToDay ?? null;
  if ('reminderDaysBefore' in data)
    updateData.reminderDaysBefore = data.reminderDaysBefore ?? null;
  if ('reminderEnabled' in data)
    updateData.reminderEnabled = data.reminderEnabled ?? null;
  if ('uploads' in data) {
