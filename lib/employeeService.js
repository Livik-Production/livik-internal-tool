...
export async function createEmployee(data) {
  ...
  const empFields = {
    ...
    bondNotRequired: payload.bondNotRequired ?? false,
...
export async function updateEmployee(id, data) {
  ...
  // -- Bond Details --
  if ('bondDuration' in data || 'bondRemarks' in data || 'bondNotRequired' in data) {
  ...
  if ('bondNotRequired' in data) {
    employeeData.bondNotRequired = !!data.bondNotRequired;
    // if bondNotRequired true, clear bond dates and duration
    if (employeeData.bondNotRequired) {
      employeeData.bondDuration = null;
      employeeData.isOnBond = false;
      employeeData.bondStartDate = null;
      employeeData.bondEndDate = null;
