...
export default function AssetPage() {
  ...
  // Loading state for form submission and asset refresh
    ...
    try {
      const response = await fetch('/api/asset-assignment', {
        ...
        body: JSON.stringify({
          assignmentId,
          ...updateData,
          assignedDate: updateData.assignmentDate,
        }),
      });
  ...
  const formatDataForAssetForm = (asset) => {
    ...
    return {
      ...
      createdBy: asset.createdBy || asset.__raw?.createdBy,
      updatedBy: asset.updatedBy || asset.__raw?.updatedBy,
    };
  };
          ...
          >
            {activeTab === 'overview' && (
              <OverviewForm
                assets={assets}
                isViewOnly={isViewOnly}
                isLoading={assetsStatus === 'loading' || isRefreshingAsset}
              />
            )}
