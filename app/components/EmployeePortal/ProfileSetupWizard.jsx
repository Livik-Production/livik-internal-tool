...
export default function ProfileSetupWizard({ rawEmployeeData }) {
  ...
  useEffect(() => {
    const checkIsComplete = (d) => !!(d?.aadhaarNumber && d?.panNumber && d?.dateOfBirth && d?.presentAddress);
            ...
            {currentStep >= 0 && (
              <div className="flex justify-center mb-12">
                <div id="photo" className="relative">
                  ...
                  <p className="absolute -bottom-9 left-1/2 -translate-x-1/2 text-[10px] text-gray-400 font-medium whitespace-nowrap">Upload PNG/JPEG images below 300KB</p>
                </div>
              </div>
            )}
