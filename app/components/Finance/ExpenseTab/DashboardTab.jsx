...
const DashboardTab = ({
  ...
  return (
    <div className=" space-y-3">
      ...
      {isLoading ? (
        <div className="flex justify-center items-center py-24 bg-white rounded-xl border border-gray-200 shadow-sm min-h-[400px]">
          <Loader
        ...
        <>
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div className="bg-blue-50 p-4 rounded-lg">
                    ...
                    <p className="text-sm text-gray-600 mt-1">
                      ₹
                      {(
                        dashboardData.topSpenders[0]?.amount || 0
                      ).toLocaleString()}
                    </p>
                  </div>
                  ...
                  <div className="bg-purple-50 p-4 rounded-lg">
                    ...
                    <p className="text-sm text-gray-600 mt-1">
                      ₹
                      {(
                        dashboardData.categories[0]?.value || 0
                      ).toLocaleString()}
                    </p>
                  </div>
                </div>
          ...
          <div className="bg-white border rounded-xl p-6 border-gray-200">
            <div className="flex justify-between items-center mb-6">
              <div>
                <h3 className="text-lg font-semibold text-gray-900">
                  Financial Health
          ...
          <div className="bg-gradient-to-r from-blue-50 to-indigo-50 rounded-xl p-6">
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
              ...
              <div className="text-center">
                ...
                <p className="text-2xl font-bold text-gray-900">
                  ₹
                  {(dashboardData.summary.avgMonthly || 0).toLocaleString(
                    'en-IN',
                    {
                      maximumFractionDigits: 0,
                    }
...
function Card({ title, icon: Icon, children, className = '' }) {
  return (
    <div
      className={`bg-white border rounded-xl p-6 border-gray-200 ${className}`}
    >
      <div className="flex justify-between items-center mb-4">
