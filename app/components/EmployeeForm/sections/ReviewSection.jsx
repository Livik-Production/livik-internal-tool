    ...
    <div className="space-y-4">
      ...
      <div className="p-4 border rounded-md">
        ...
        <div className="text-sm text-gray-700">
          ...
          {form.workMode === 'WFO' && form.wfoOffice
            ? ` (${form.wfoOffice})`
            : ''}
        </div>
        <div className="text-sm text-gray-700">
        ...
        <div className="grid grid-cols-3 gap-4 mb-6">
          <div className="flex flex-col items-center text-center">
            ...
            {form.photo ? (
              ...
              <div className="w-16 h-16 bg-gray-50 rounded-xl border flex items-center justify-center text-[10px] text-gray-400">
                N/A
              </div>
            )}
          </div>
          <div className="flex flex-col items-center text-center">
            ...
            {form.aadhaarCard ? (
              form.aadhaarCard.toLowerCase().endsWith('.pdf') ? (
                <div className="w-16 h-16 bg-blue-50 rounded-xl border border-blue-100 flex items-center justify-center text-[10px] text-blue-500 font-bold uppercase">
                  PDF
                </div>
              ) : (
                <img
                  src={form.aadhaarCard}
                  alt="Aadhaar"
                  className="w-16 h-16 object-cover rounded-xl border border-blue-100 shadow-sm"
                />
              )
          ...
          <div className="flex flex-col items-center text-center">
            ...
            {form.panCard ? (
              form.panCard.toLowerCase().endsWith('.pdf') ? (
                <div className="w-16 h-16 bg-purple-50 rounded-xl border border-purple-100 flex items-center justify-center text-[10px] text-purple-500 font-bold uppercase">
                  PDF
                </div>
              ) : (
                <img
                  src={form.panCard}
                  alt="PAN"
                  className="w-16 h-16 object-cover rounded-xl border border-purple-100 shadow-sm"
                />
              )
            ) : (
              <div className="w-16 h-16 bg-gray-50 rounded-xl border flex items-center justify-center text-[10px] text-gray-400">
