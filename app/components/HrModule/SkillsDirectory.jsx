...
const SkillsDirectory = ({ isTab = false, isViewOnly = false }) => {
  ...
  const finalDepartments = dropdownDepartments.length > 0
  ...
  const finalLevels = dropdownLevels.length > 0
    ...
    const fetchDropdowns = async () => {
      try {
        ...
        if (deptRes.ok) {
          ...
          if (deptJson.data) setDropdownDepartments(deptJson.data.map(d => d.value));
        }
                ...
                <div className="space-y-4">
                  ...
                  <div className="flex flex-col md:flex-row gap-3">
                    ...
                    <div className="relative flex-1">
                      ...
                      >
                        {finalLevels.filter(lvl => lvl !== 'All Employees').map(lvl => (
