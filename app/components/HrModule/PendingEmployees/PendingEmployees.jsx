...
export default function PendingEmployees({
  ...
  const handleStatusChange = async () => {
    ...
    try {
      ...
      showAlert('Success', `${employee.name} has been approved and activated!`, 'success');
      ...
      showAlert('Error', 'Failed to update status. Please try again.', 'danger');
    } finally {
      setIsUpdating(false);
    }
  };
  ...
  const handleApproveAllConfirm = async () => {
    ...
    try {
      ...
      showAlert('Success', `Approved all ${approvedCount} employees`, 'success');
    } catch (error) {
